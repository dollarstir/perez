...
<body>
  ...
  <div class="intro intro-carousel">
    <div id="carousel" class="owl-carousel owl-theme">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(img/attachments/2.jpg)" style="width:1920px;height:960px;">
        <div class="overlay overlay-a"></div>
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="container">
      ...
      <div class="carousel-item-a intro-item bg-image" style="background-image: url(img/attachments/3.jpg)" style="width:1920px;height:960px;">
        <div class="overlay overlay-a"></div>
        <div class="intro-content display-table">
          <div class="table-cell">
            <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-wrap d-flex justify-content-between">
            <div class="title-box">
             <u> <h2 class="title-a">Our Services</h2></u>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card-box-c foo">
            <div class="card-header-c d-flex">
              ...
              <div class="card-title-c align-self-center">
                <h2 class="title-c">	Real Estate</h2>
              </div>
            </div>
        ...
        <div class="col-md-4">
          <div class="card-box-c foo">
            <div class="card-header-c d-flex">
              ...
              <div class="card-title-c align-self-center">
                <h2 class="title-c">	Real Estate Agency </h2>
              </div>
            </div>
            <div class="card-body-c">
              <p class="content-c">
        ...
        <div class="col-md-4">
          <div class="card-box-c foo">
            <div class="card-header-c d-flex">
              ...
              <div class="card-title-c align-self-center">
                <h2 class="title-c">	Waste Management</h2>
              </div>
            </div>
            <div class="card-body-c">
              <p class="content-c">
    ...
    <div class="container">
      ...
      <div id="property-carousel" class="owl-carousel owl-theme">
        ...
        <div class="carousel-item-b">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="img/attachments/3.jpg" alt="" class="img-a img-fluid" style="width:600px;height:400px;">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
        ...
        <div class="carousel-item-b">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="img/attachments/4.jpg" alt="" class="img-a img-fluid" style="width:600px;height:400px;">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
              ...
              <div class="col-sm-12 col-md-6">
                ...
                <div class="testimonials-content">
                  <p class="testimonial-text">
                    Perez Investment is our solid patner .We appreciate your good work
                  </p>
                </div>
          ...
          <div class="testimonials-box">
            <div class="row">
              ...
              <div class="col-sm-12 col-md-6">
                ...
                <div class="testimonials-content">
                  <p class="testimonial-text">
                    We bought our land easily and conviniently with Perez Investment  Ltd 
                  </p>
                </div>
                <div class="testimonial-author-box">
...
<!-- Mirrored from bootstrapmade.com/demo/themes/EstateAgency/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Aug 2019 12:18:40 GMT -->
</html>
