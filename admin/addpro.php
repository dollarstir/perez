                    ...
                    <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing"   style="margin: auto;">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">                                
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                       <center> <u><h4>Add Property</h4></u></center>
                                    </div>                                                      
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <form class="subcourse">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input name="name" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Property name">
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="location" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Enter Location of property">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="price" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Price of Land (you can leave it empty)">
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                      ...
                                      <select name="ptype" class="form-control-rounded form-control" id="exampleFormControlSelect1">
                                  ...
                                  <div class="form-group mb-4">
                                      ...
                                      <select name="pcat" class="form-control-rounded form-control" id="exampleFormControlSelect1">
                                  ...
                                  <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="area" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Area of Land (Length x Breadth) you can leave it  empty">
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="bed" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Number of Beds if any . You can leave it  empty">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="bath" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Number of bath room if any . You can leave it  empty">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="garage" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Number of Garage if any . You can leave it  empty">
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        <label for="exampleFormControlTextarea1">Enter short Description of Property</label>
                                        <textarea name="description" class="form-control-rounded form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                                    </div>

                                    
                                   
                                    <input type="submit" name="subc" class="mt-4 mb-4 btn btn-button-7 btn-rounded sub" value="Add Property" style="margin-left:150px;background-color:green !important;">
                ...
                <div class="col-xl-5 col-md-6 col-sm-6 col-12">
                    <ul class="list-inline mb-0 d-flex justify-content-sm-end justify-content-center mr-sm-3 ml-sm-0 mx-3">
                        <li class="list-inline-item  mr-3">
                            <p class="bottom-footer">© <?php echo date("Y");?> <a target="_blank" href="#">Designed by Dolllarsoft Corporation</a></p>
                        </li>
